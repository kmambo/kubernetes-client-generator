...
from kubernetes_asyncio_pydantic import ApiClient, Configuration

from ..config.exec_provider import ExecProvider
...
class KubeConfigLoader:
    ...
    def __init__(
        ...
        async def _refresh_credentials_with_cmd_path():
        ...
        async def _refresh_credentials():
            ...
            if (
                ...
                return await _refresh_credentials_with_cmd_path()
    ...
    async def _load_gcp_token(self, provider):
        if (
    ...
    async def _refresh_gcp_token(self):
